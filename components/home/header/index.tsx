...
export default function Header() {
    ...
    return (
        <section id="home" className="relative flex overflow-hidden  justify-center items-center h-192.5  max-md:h-full  max-md:py-24 w-full  bg-white">
                ...
                <div className="grid max-md:mt-5 grid-cols-1  md:grid-cols-2 gap-12 h-fit items-center justify-center">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Button variant={"outline"} className={' rounded-xl border-primary px-8 py-6 font-semibold text-primary hover:bg-blue-50 transition-colors duration-200'}>
                                <Link
                                    href="#courses"
