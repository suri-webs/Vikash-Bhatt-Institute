...
const inputCls =
  "rounded-xl border-[#0BBFE0] focus-visible:ring-cyan-100 text-gray-800 placeholder:text-gray-300 text-sm";

export function AdditionalInfoSection({
  location, bio, editing, onLocationChange, onBioChange,
}: AdditionalInfoProps) {
  return (
    <div>
          ...
          {editing ? (
            <>
              <Textarea
                ...
                className="rounded-xl border-[#0BBFE0] focus-visible:ring-cyan-100 text-gray-800 placeholder:text-gray-300 resize-none text-sm"
              />
